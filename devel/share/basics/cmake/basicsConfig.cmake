  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'mkhuthir <mkhuthir@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkhuthir/catkin_ws/src/basics/${idir}'.  Ask the maintainer 'mkhuthir <mkhuthir@todo.todo>' to fix it.")
    endif()
