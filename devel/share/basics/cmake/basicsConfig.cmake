...
if("TRUE" STREQUAL "TRUE")
  set(basics_SOURCE_PREFIX /home/mkhuthir/learnROS/src/basics)
  set(basics_DEVEL_PREFIX /home/mkhuthir/learnROS/devel)
  set(basics_INSTALL_PREFIX "")
  set(basics_PREFIX ${basics_DEVEL_PREFIX})
else()
  set(basics_SOURCE_PREFIX "")
  set(basics_DEVEL_PREFIX "")
  set(basics_INSTALL_PREFIX /home/mkhuthir/learnROS/install)
...
if(NOT "/home/mkhuthir/learnROS/devel/include " STREQUAL " ")
  set(basics_INCLUDE_DIRS "")
  set(_include_dirs "/home/mkhuthir/learnROS/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Muthanna Attyah <mkhuthir@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkhuthir/learnROS/src/basics/${idir}'.  Ask the maintainer 'Muthanna Attyah <mkhuthir@gmail.com>' to fix it.")
    endif()
