...
(cl:defclass <PoseTrajectory> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass PoseTrajectory (<PoseTrajectory>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PoseTrajectory>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PoseTrajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nasa_r2_common_msgs-msg:<PoseTrajectory> is deprecated: use nasa_r2_common_msgs-msg:PoseTrajectory instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PoseTrajectory>))
...
(cl:defmethod nodes-val ((m <PoseTrajectory>))
...
(cl:defmethod node_priorities-val ((m <PoseTrajectory>))
...
(cl:defmethod refFrames-val ((m <PoseTrajectory>))
...
(cl:defmethod points-val ((m <PoseTrajectory>))
  ...
  (points m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PoseTrajectory>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PoseTrajectory>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PoseTrajectory>))
  "Converts a ROS message object to a list"
  (cl:list 'PoseTrajectory
