...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2iI.pack(_x.result.time_elapsed.secs, _x.result.time_elapsed.nsecs, _x.result.updates_sent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.time_elapsed.secs, _x.result.time_elapsed.nsecs, _x.result.updates_sent,) = _struct_2iI.unpack(str[start:end])
      return self
