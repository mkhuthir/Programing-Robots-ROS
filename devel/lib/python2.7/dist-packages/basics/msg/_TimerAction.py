...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_goal.goal.time_to_wait.secs, _x.action_goal.goal.time_to_wait.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i4I.pack(_x.action_result.result.time_elapsed.secs, _x.action_result.result.time_elapsed.nsecs, _x.action_result.result.updates_sent, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4i.pack(_x.action_feedback.feedback.time_elapsed.secs, _x.action_feedback.feedback.time_elapsed.nsecs, _x.action_feedback.feedback.time_remaining.secs, _x.action_feedback.feedback.time_remaining.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.time_to_wait.secs, _x.action_goal.goal.time_to_wait.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.time_elapsed.secs, _x.action_result.result.time_elapsed.nsecs, _x.action_result.result.updates_sent, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_2i4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.time_elapsed.secs, _x.action_feedback.feedback.time_elapsed.nsecs, _x.action_feedback.feedback.time_remaining.secs, _x.action_feedback.feedback.time_remaining.nsecs,) = _struct_4i.unpack(str[start:end])
      return self
