...
"""autogenerated by genpy from basics/TalkActionResult.msg. Do not edit."""
import sys
...
class TalkActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "basics/TalkActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','basics/TalkResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TalkActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = basics.msg.TalkResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = basics.msg.TalkResult()
