...
"""autogenerated by genpy from basics/TalkActionFeedback.msg. Do not edit."""
import sys
...
class TalkActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "basics/TalkActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','basics/TalkFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TalkActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = basics.msg.TalkFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = basics.msg.TalkFeedback()
