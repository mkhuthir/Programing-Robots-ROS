...
"""autogenerated by genpy from nasa_r2_common_msgs/PoseTrajectoryReplan.msg. Do not edit."""
import sys
...
class PoseTrajectoryReplan(genpy.Message):
  _md5sum = "2c451df74f58d0f7ac206299290fa0f9"
  _type = "nasa_r2_common_msgs/PoseTrajectoryReplan"
...
float64 z
"""
  __slots__ = ['header','replan','trajectory']
  _slot_types = ['std_msgs/Header','nasa_r2_common_msgs/ReplanType','nasa_r2_common_msgs/PoseTrajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseTrajectoryReplan, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.replan is None:
        self.replan = nasa_r2_common_msgs.msg.ReplanType()
      if self.trajectory is None:
        self.trajectory = nasa_r2_common_msgs.msg.PoseTrajectory()
    else:
      self.header = std_msgs.msg.Header()
      self.replan = nasa_r2_common_msgs.msg.ReplanType()
      self.trajectory = nasa_r2_common_msgs.msg.PoseTrajectory()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_B3I.pack(_x.replan.type, _x.trajectory.header.seq, _x.trajectory.header.stamp.secs, _x.trajectory.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.trajectory.nodes)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory.nodes:
        length = len(val1)
      ...
      length = len(self.trajectory.node_priorities)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory.node_priorities:
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.trajectory.refFrames)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory.refFrames:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.replan.type, _x.trajectory.header.seq, _x.trajectory.header.stamp.secs, _x.trajectory.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.trajectory.nodes.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.trajectory.node_priorities = []
      for i in range(0, length):
        ...
        self.trajectory.node_priorities.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.trajectory.refFrames = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.trajectory.refFrames.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
