...
"""autogenerated by genpy from nasa_r2_common_msgs/JointTrajectoryReplan.msg. Do not edit."""
import sys
...
class JointTrajectoryReplan(genpy.Message):
  _md5sum = "282383b42345996d1c9b14b7391111c8"
  _type = "nasa_r2_common_msgs/JointTrajectoryReplan"
...
"""
  ...
  _slot_types = ['std_msgs/Header','nasa_r2_common_msgs/ReplanType[]','trajectory_msgs/JointTrajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointTrajectoryReplan, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = nasa_r2_common_msgs.msg.ReplanType()
        start = end
        end += 1
        (val1.type,) = _struct_B.unpack(str[start:end])
        self.replan.append(val1)
      _x = self
      start = end
      end += 12
