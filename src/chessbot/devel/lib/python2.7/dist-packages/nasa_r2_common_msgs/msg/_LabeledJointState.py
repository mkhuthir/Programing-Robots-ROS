...
"""autogenerated by genpy from nasa_r2_common_msgs/LabeledJointState.msg. Do not edit."""
import sys
...
class LabeledJointState(genpy.Message):
  _md5sum = "dcbf606d25a558e3de2e3c95fa2eaca9"
  _type = "nasa_r2_common_msgs/LabeledJointState"
...
"""
  __slots__ = ['header','originator','name','position','velocity','effort']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,originator,name,position,velocity,effort
    ...
    """
    if args or kwds:
      super(LabeledJointState, self).__init__(*args, **kwds)
