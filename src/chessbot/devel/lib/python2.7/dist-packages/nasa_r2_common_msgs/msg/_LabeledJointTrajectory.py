...
"""autogenerated by genpy from nasa_r2_common_msgs/LabeledJointTrajectory.msg. Do not edit."""
import sys
...
class LabeledJointTrajectory(genpy.Message):
  _md5sum = "aff6b60e17ee1f6c52f656a567f354a4"
  _type = "nasa_r2_common_msgs/LabeledJointTrajectory"
...
"""
  __slots__ = ['header','originator','joint_names','points']
  _slot_types = ['std_msgs/Header','string','string[]','trajectory_msgs/JointTrajectoryPoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,originator,joint_names,points
    ...
    """
    if args or kwds:
      super(LabeledJointTrajectory, self).__init__(*args, **kwds)
