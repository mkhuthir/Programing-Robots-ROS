...
"""autogenerated by genpy from nasa_r2_common_msgs/PoseTrajectory.msg. Do not edit."""
import sys
...
class PoseTrajectory(genpy.Message):
  _md5sum = "635ae07b754d8dde1d1ec77316124e02"
  _type = "nasa_r2_common_msgs/PoseTrajectory"
...
float64 z
"""
  __slots__ = ['header','nodes','node_priorities','refFrames','points']
  _slot_types = ['std_msgs/Header','string[]','nasa_r2_common_msgs/PriorityArray[]','string[]','nasa_r2_common_msgs/PoseTrajectoryPoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,nodes,node_priorities,refFrames,points
    ...
    """
    if args or kwds:
      super(PoseTrajectory, self).__init__(*args, **kwds)
