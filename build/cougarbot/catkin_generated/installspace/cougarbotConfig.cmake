...
if("FALSE" STREQUAL "TRUE")
  set(cougarbot_SOURCE_PREFIX /home/mkhuthir/learnROS/src/cougarbot)
  set(cougarbot_DEVEL_PREFIX /home/mkhuthir/learnROS/devel)
  ...
  set(cougarbot_INSTALL_PREFIX /home/mkhuthir/learnROS/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cougarbot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'mkhuthir <mkhuthir@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'cougarbot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkhuthir/learnROS/install/${idir}'.  Ask the maintainer 'mkhuthir <mkhuthir@todo.todo>' to fix it.")
    endif()
