...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mkhuthir/learnROS/install/${idir}'.  Ask the maintainer 'Muthanna Attyah <mkhuthir@gmail.com>' to fix it.")
    endif()
